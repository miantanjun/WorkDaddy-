...
chmod 644 "$APP/Contents/Resources/scripts/session-db.js" \
  ...
  "$APP/Contents/Resources/scripts/stats-discipline.js" \
  "$APP/Contents/Resources/scripts/thinking-stats.js" \
  "$APP/Contents/Resources/scripts/usage-unified.js" \
  "$APP/Contents/Resources/scripts/usage-board-html.js" \
  "$APP/Contents/Resources/scripts/session-titles.js" \
  "$APP/Contents/Resources/scripts/session-cost.js" \
